...
acep_postag <- function(texto,
  ...
  texto_only_entity_loc <- base::merge(texto_only_entity_loc, texto_tag[ , c("doc_id", "sentence")], by = c("doc_id", "sentence"))
  texto_only_entity_loc <- base::unique(subset(texto_only_entity_loc, !is.na(lat)))
