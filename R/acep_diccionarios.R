...
#' @description Colección de diccionarios que reúne diccionarios de diferentes orígenes. Los diccionarios dicc_confl_gp y dicc_viol_gp fueron extraidos de Albrieu y Palazzo (2020).
#' @examples
