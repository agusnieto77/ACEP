...
acep_plot_st(
 ...
 t = "Indice anual de conflictividad en la industria del pescado (MdP)",
...
acep_plot_st(
 conf_gral$st,
 conf_gral$frecm,
 t = "Indice mensual de conflictividad en la industria del pescado (MdP)",
 ejey = "Menciones del diccionario",
 etiquetax = "vertical"
             )
...
acep_plot_st(
 huelgas$st,
 huelgas$frecm,
 t = "Indice mensual de huelgas en la industria del pescado (MdP)",
 ejey = "Menciones del diccionario",
 etiquetax = "vertical"
             )
...
Las distintas métricas nos ayudan a identificar al año 2012 como el más conflictivo del período en el ámbito de la industria de procesado en tierra en al ciudad de Mar del Plata, con epicentro en los meses de junio, julio y agosto para la conflictividad general y durante los meses de mayo, junio y julio para los movimientos huelguísticos. 
