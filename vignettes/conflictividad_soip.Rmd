...
```{r diccionarios, eval=require("tibble")}
...
En esta parte del código usaremos la función `acep_rst()` para calcular los índices agrupados por año y mes. Primero construimos la serie de tiempo para la conflictividad general.

```{r temporal0, eval=require("tibble")}
...
```{r temporal, eval=require("tibble")}
...
```{r temporal_huelgas, eval=require("tibble")}
