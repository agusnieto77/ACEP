...
cat("\nLa nueva versión (acep_cleaning) procesa los datos ingresados en", FUN.v2[3], "segundos.", 
...
cat("\nLa nueva versión (acep_count) procesa los datos ingresados en", FUN.v2[3], "segundos.", 
