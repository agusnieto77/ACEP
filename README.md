...
| `acep_plot_st()`     | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-stable.svg)       | Gráfico de barras de la serie temporal de indices de conflictividad.              |
...
| `acep_rst()`         | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-deprecated.svg)   | Serie temporal de indices de conflictividad.                                      |
| `acep_sst()`         | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-stable.svg)       | Serie temporal de indices de conflictividad.                                      |
...
| `acep_token_plot()`  | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-experimental.svg) | Gráfico de barras de palabras mas recurrentes en un corpus.                       |
...
# Ahora con la función acep_int() calculamos un indice de intensidad de
