...
| `acep_postag()`      | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-stable.svg)       | Funcion para etiquetado POS, lematizacion, tokenizacion, extraccion de entidades. |
