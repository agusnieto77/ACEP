...
| `acep_post_rst()`    | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-stable.svg)       | Resumen visual de la serie temporal de los indices de conflictividad. |
| `acep_post_st()`     | ![](https://lifecycle.r-lib.org/articles/figures/lifecycle-stable.svg)       | Grafico de barras de la serie temporal de indices de conflictividad.  |
